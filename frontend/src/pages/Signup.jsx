...
const Signup = () => {
  ...
  // Listen for Google popup postMessage
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 dark:bg-slate-50 pt-20 pb-10 transition-colors duration-500">
      <div className="bg-slate-800 dark:bg-white p-8 rounded-xl shadow-2xl w-full max-w-md border border-slate-700 dark:border-slate-200 relative z-10">
        ...
        {/* Google Button first (professional pattern) */}
        <button
          type="button"
          onClick={handleGoogleSignIn}
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-50 text-slate-700 font-semibold py-2.5 rounded-lg transition-colors border border-slate-300 shadow-sm disabled:opacity-50 mb-4"
        >
